...
public class SignInput {
    ...
    @Schema(example = "true", description = "A boolean, if false it that the PDF signature will be invisible. If true it means the user can draw a signature form on the PDF, or select an existing signature form, where a visible signature will display the signature details")
