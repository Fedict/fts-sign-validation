...
public class SignInput {
    ...
    @Schema(example = "true", description = "A boolean, if true it that the PDF signature will be invisible. If false it means the user can draw a rectangle on the PDF, or select an existing rectangle, where a visible signature will display the signature details")
