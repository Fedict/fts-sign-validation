...
//            try (FileOutputStream fos = new FileOutputStream("signed.file")) { fos.write(signedDoc.getBytes()); }
        ...
        public RemoteDocument signDocumentMultiple(SignDocumentMultipleDTO signDocumentDto) {
            try {
                checkAndRecordMDCToken(signDocumentDto.getToken());
        ...
        public DataToSignDTO getDataToSign(GetDataToSignXMLElementsDTO getDataToSignDto) {
            try {
        ...
        public RemoteDocument signDocument(SignXMLElementsDTO signDto) {
            try {
